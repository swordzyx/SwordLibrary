...
public class CameraManager {
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        ...
        try {
            ...
            LogCollector.warn("Camera reject parameters. Setting only minimal safe-mode parameters");
            LogCollector.debug("Resetting to saved camera params: " + paramFlattened);
            ...
            if (paramFlattened != null) {
                ...
                try {
                    ...
                    ex2.printStackTrace();
                    LogCollector.warn("Camera reject even safe-mode parameters");
                }
            }
        }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
        ...
        LogCollector.debug("build srouce width: " + width + "----height: " + height);
...
//            LogUtil.debug("framingRect.left: " + framingRect.left + "---framingRect.right: " + framingRect.right + "----framingRect.top: " + framingRect.top + "---framingRect.bottom: " + framingRect.bottom + "---framingRect.width: " + framingRect.width() + "----framingRect.height: " + framingRect.height());
            ...
            LogCollector.debug("cameraResolution x: " + cameraResolution.x + "----y: " + cameraResolution.y);
            LogCollector.debug("screenResolution x: " + screenResolution.x + "----y: " + screenResolution.y);

            //计算矩形扫描区域的显示位置
            LogCollector.debug("rect.left: " + rect.left + "---rect.right: " + rect.right + "----rect.top: " + rect.top + "---rect.bottom: " + rect.bottom + "---rect.width: " + rect.width() + "----rect.height: " + rect.height());
...
//            LogUtil.debug("ratio y: " + scaleY);
            ...
            LogCollector.debug("framingRectInPreview.left: " + framingRectInPreview.left + "---framingRectInPreview.right: " + framingRectInPreview.right + "----framingRectInPreview.top: " + framingRectInPreview.top + "---framingRectInPreview.bottom: " + framingRectInPreview.bottom + "---framingRectInPreview.width: " + framingRectInPreview.width() + "----framingRectInPreview.height: " + framingRectInPreview.height());
        }
